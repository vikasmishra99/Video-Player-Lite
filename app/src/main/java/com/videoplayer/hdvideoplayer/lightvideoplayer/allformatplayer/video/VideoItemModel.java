...
public class VideoItemModel {
    ...
    public VideoItemModel(String videoTitle, String path, String duration, String folderName, String fileSize, String resolution, long fileSizeAsFloat, String date_added) {
