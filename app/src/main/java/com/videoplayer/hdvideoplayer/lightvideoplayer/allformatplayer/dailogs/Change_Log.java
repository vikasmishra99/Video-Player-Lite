...
public class Change_Log extends DialogFragment {
    public static Change_Log create() {
        return new Change_Log();
    }
...
// Load from change_log.html in the assets folder
            ...
            InputStream json = getContext().getApplicationContext().getAssets().open("change_log.html");
